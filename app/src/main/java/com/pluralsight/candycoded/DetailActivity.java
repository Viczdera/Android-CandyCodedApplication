...
public class DetailActivity extends AppCompatActivity {
    ...
    String derasContatinatedString= SHARE_DESCRIPTION+HASHTAG_CANDYCODED+mCandyImageUrl;
    ...
    // ***
    // TODO - Task 4 - Share the Current Candy with an Intent= DONE
    // Sharing Candy with intent
    @Override
    ...
    private void createShareIntent(){
        ...
        shareIntent.putExtra(Intent.EXTRA_TEXT,derasContatinatedString);
